...
from evaluate import evaluate_model, plot_history, plot_prediction_sample
...
def main():
    ...
    print("--" * 30)
    print("Neural Network Image Recognition: Tiger vs Lion")
    print("--" * 30)
    ...
    # สร้างและบันทึกรูปตัวอย่างการทำนายผล
