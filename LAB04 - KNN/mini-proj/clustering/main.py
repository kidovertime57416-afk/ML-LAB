...
#STEP 5  Use KNN to classify a new car.
...
N_CLUSTERS = 3 #ปรับจำนวนกลุ่มตามลักษณะรถ (เช่น รถประหยัด, รถขนาดกลาง, รถสมรรถนะสูง)
KNN_K = 5           
...
def main():
    ...
    #  scatter plot use Horsepower (คอลัมน์ 3) กับ Weight (คอลัมน์ 4)
    visualize.plot_clusters(X_raw[:, [3, 4]], labels, OUT_DIR / "02_clusters.png")
    ...
    title(f"STEP 5 : use  KNN detec car into groups (k = {KNN_K})")
  
    # จำลองสถานการณ์: สมมติเรารู้กลุ่มของรถ 200 คันแรก
    # แล้วอีก 100 คันเป็น "รถคันใหม่" ที่เพิ่งเข้ามา
    n_known = 200
    ...
    # =====================================================================
    result = df.copy()
    result["cluster"] = labels        # เพิ่มคอลัมน์บอกว่าแต่ละคันอยู่กลุ่มไหน
    result.to_csv(OUT_DIR / "clustered_cars.csv",
